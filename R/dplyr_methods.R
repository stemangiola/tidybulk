...
#' se_mini |> tidybulk() |> as_tibble() |> left_join(annotation)
#' 
...
#'                 distinct(.sample) |> mutate(source = "AU")
#' se_mini |> tidybulk() |> as_tibble() |> inner_join(annotation)
#'
...
#' annotation <- se_mini |> tidybulk() |> as_tibble() |> 
#'                 distinct(.sample) |> mutate(source = "AU")
#' se_mini |> tidybulk() |> as_tibble() |> right_join(annotation)
#'
