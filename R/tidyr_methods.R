...
#' @examples
#' data(se_mini)
#' se_mini |> tidybulk() |> nest( data = -.feature) |> unnest(data)
#'
#' @importFrom tidyr unnest
#' @importFrom rlang enquo
#' @export
unnest.nested_tidybulk <- function (data, cols, ..., keep_empty=FALSE, 
      ptype=NULL, names_sep=NULL, names_repair="check_unique", 
