...
<!-- } -->
<!-- </style> -->
<!-- Hack above didn't solve the truncated column problem :( -->
...
For visualisation purposes or ad hoc analyses, we may want to rotate the reduced dimensions (or any two numeric columns really) of our data, of a set angle. The rotated dimensions will be added to the original data set as `<NAME OF DIMENSION> rotated <ANGLE>` by default, or as specified in the input arguments.
