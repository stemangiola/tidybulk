...
Although the full power of ttBulk approach is in the `tibble` representation of the data, all functions are directly compatible with `SummarizedExperiment`
